...
// OG image generata per lingua (anteprima quando il link viene condiviso su
// WhatsApp, Facebook, LinkedIn…). Brand "Sala di Controllo": navy + teal.
// L'alt è statico e uguale nelle due lingue: generateImageMetadata viene
// invocata da Next anche senza `locale` (enumerazione degli id) e andava in 500.
export const alt = "CleanFlow";
