...
import {
  ...
  PerCurrency,
  Price,
} from "@/components/site/currency";
import { DEFAULT_CURRENCY, readPiani } from "@/lib/piani";
...
//
// v3 (09/09/2026) — Valuta a scelta: euro, dollaro, sterlina. La sezione resta
// server-rendered; cambiano solo tre isole client (components/site/currency.tsx):
// il selettore sotto il lead, il prezzo delle card e quello nell'intestazione
// del confronto. Default: € in italiano, £ in inglese.
...
export function Prezzi() {
  ...
  // Oggetto per valuta, non una stringa: `t.raw` accetta solo chiavi foglia (o
  // array), `useMessages` lo restituisce già tipizzato dal dizionario italiano.
  const perMonth = useMessages().Prezzi.perMonth;
  ...
  return (
    ...
    >
      <CurrencyProvider initial={DEFAULT_CURRENCY[locale]}>
        <div className="mx-auto max-w-[69rem] px-5 sm:px-8">
          <div className="max-w-2xl">
            ...
            <div className="mt-6">
              <CurrencyPicker label={t("currencyLabel")} />
            </div>
          </div>
                ...
                >
                  ...
                  <div className="relative flex flex-1 flex-col">
                    ...
                    <div className="mt-5 flex items-baseline gap-1.5">
                      ...
                      >
                        <Price prices={p.prices} symbolClassName="text-accent" />
                      </span>
                      <span
                        className={cn(
                          "font-mono text-sm",
