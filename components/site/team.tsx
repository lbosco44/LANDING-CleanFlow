...
const TEAM: Membro[] = [
  { key: "jacopo", nome: "Jacopo Serra", iniziali: "JS", foto: "/team/jacopo.png" },
  { key: "lorenzo", nome: "Lorenzo Bosco", iniziali: "LB", foto: "/team/lorenzo.png" },
  { key: "michele", nome: "Michele Raffone", iniziali: "MR", foto: "/team/michele.png" },
];
              ...
              <li key={m.nome} className="bg-card p-6 sm:p-7">
                ...
                <div className="flex items-center gap-4 sm:block">
                  ...
                  <div className="sm:mt-5">
                    ...
                    <p className="eyebrow mt-1.5 text-accent-ink">{ruolo}</p>
                  </div>
                </div>
              </li>
            );
